...
cd aiml-companion/projects/machine-learning/lapse-prediction
```
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/genieincodebottle/aiml-companion/blob/main/projects/machine-learning/lapse-prediction/notebooks/lapse_prediction_standalone.ipynb)
...
| `ModuleNotFoundError: lapse_prediction` | running without installing, from the wrong directory | run from `projects/machine-learning/lapse-prediction` with `PYTHONPATH=src` |
