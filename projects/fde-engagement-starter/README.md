...
cd aiml-companion/projects/fde-engagement-starter
...
- **A working agent.** You build it. If you want to see a finished multi-agent system for reference, read [due-diligence-agent](https://github.com/genieincodebottle/aiml-companion/tree/main/projects/due-diligence-agent).
...
Run these from the project root (`aiml-companion/projects/fde-engagement-starter`). The tests import `src.*`, so running `pytest` from somewhere else will not find the package.
