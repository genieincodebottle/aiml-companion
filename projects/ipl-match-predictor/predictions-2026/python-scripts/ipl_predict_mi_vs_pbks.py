"""
IPL 2026 Match Prediction: MI vs PBKS (Match 24, April 16, 2026)
================================================================
...
print("=" * 70)
print("  IPL 2026 MATCH PREDICTION: MI vs PBKS")
print("  Match 24 | Wankhede Stadium, Mumbai")
print("  April 16, 2026 | 7:30 PM IST")
print("=" * 70)
...
ipl_2025_plus_matches = [
    # MI 2025: 9W-7L, 4th place - lost in Qualifier 2 to PBKS
    ...
    # PBKS 2025: 10W-4L, 1st place (NRR) - lost final to RCB by 6 runs
    {"date": "2025-03-26", "team1": "Punjab Kings", "team2": "Delhi Capitals", "winner": "Punjab Kings", "city": "Mohali", "venue": "Maharaja Yadavindra Singh International Cricket Stadium", "toss_winner": "Punjab Kings", "toss_decision": "bat", "result": "runs", "result_margin": 30},
    {"date": "2025-04-02", "team1": "Punjab Kings", "team2": "Rajasthan Royals", "winner": "Punjab Kings", "city": "Mohali", "venue": "Maharaja Yadavindra Singh International Cricket Stadium", "toss_winner": "Punjab Kings", "toss_decision": "bat", "result": "runs", "result_margin": 20},
    {"date": "2025-04-10", "team1": "Mumbai Indians", "team2": "Punjab Kings", "winner": "Punjab Kings", "city": "Mumbai", "venue": "Wankhede Stadium", "toss_winner": "Punjab Kings", "toss_decision": "field", "result": "wickets", "result_margin": 4},
    {"date": "2025-04-16", "team1": "Kolkata Knight Riders", "team2": "Punjab Kings", "winner": "Punjab Kings", "city": "Kolkata", "venue": "Eden Gardens", "toss_winner": "Punjab Kings", "toss_decision": "field", "result": "wickets", "result_margin": 5},
    {"date": "2025-04-22", "team1": "Punjab Kings", "team2": "Lucknow Super Giants", "winner": "Lucknow Super Giants", "city": "Mohali", "venue": "Maharaja Yadavindra Singh International Cricket Stadium", "toss_winner": "Lucknow Super Giants", "toss_decision": "field", "result": "wickets", "result_margin": 3},
    {"date": "2025-04-28", "team1": "Gujarat Titans", "team2": "Punjab Kings", "winner": "Punjab Kings", "city": "Ahmedabad", "venue": "Narendra Modi Stadium", "toss_winner": "Punjab Kings", "toss_decision": "field", "result": "wickets", "result_margin": 6},
    ...
    {"date": "2025-05-12", "team1": "Punjab Kings", "team2": "Sunrisers Hyderabad", "winner": "Punjab Kings", "city": "Mohali", "venue": "Maharaja Yadavindra Singh International Cricket Stadium", "toss_winner": "Punjab Kings", "toss_decision": "bat", "result": "runs", "result_margin": 25},
    {"date": "2025-05-18", "team1": "Chennai Super Kings", "team2": "Punjab Kings", "winner": "Punjab Kings", "city": "Chennai", "venue": "MA Chidambaram Stadium", "toss_winner": "Punjab Kings", "toss_decision": "field", "result": "wickets", "result_margin": 5},
    {"date": "2025-05-24", "team1": "Punjab Kings", "team2": "Gujarat Titans", "winner": "Punjab Kings", "city": "Mohali", "venue": "Maharaja Yadavindra Singh International Cricket Stadium", "toss_winner": "Punjab Kings", "toss_decision": "bat", "result": "runs", "result_margin": 30},
    {"date": "2025-05-30", "team1": "Delhi Capitals", "team2": "Punjab Kings", "winner": "Delhi Capitals", "city": "Delhi", "venue": "Arun Jaitley Stadium", "toss_winner": "Delhi Capitals", "toss_decision": "bat", "result": "runs", "result_margin": 12},
    {"date": "2025-06-01", "team1": "Punjab Kings", "team2": "Sunrisers Hyderabad", "winner": "Sunrisers Hyderabad", "city": "Mohali", "venue": "Maharaja Yadavindra Singh International Cricket Stadium", "toss_winner": "Sunrisers Hyderabad", "toss_decision": "field", "result": "wickets", "result_margin": 4},
    {"date": "2025-06-05", "team1": "Punjab Kings", "team2": "Mumbai Indians", "winner": "Punjab Kings", "city": "Ahmedabad", "venue": "Narendra Modi Stadium", "toss_winner": "Punjab Kings", "toss_decision": "bat", "result": "runs", "result_margin": 10},

    # IPL 2026 results so far (Matches 1-23)
    # Match 1: RCB beat SRH
    ...
    # Match 3: MI beat KKR
    {"date": "2026-03-29", "team1": "Mumbai Indians", "team2": "Kolkata Knight Riders", "winner": "Mumbai Indians", "city": "Mumbai", "venue": "Wankhede Stadium", "toss_winner": "Mumbai Indians", "toss_decision": "bat", "result": "wickets", "result_margin": 6},
    # Match 4: RR beat CSK
    {"date": "2026-04-01", "team1": "Rajasthan Royals", "team2": "Chennai Super Kings", "winner": "Rajasthan Royals", "city": "Jaipur", "venue": "Sawai Mansingh Stadium", "toss_winner": "Rajasthan Royals", "toss_decision": "bat", "result": "runs", "result_margin": 17},
    # Match 5: DC beat LSG
    ...
    # Match 13: PBKS vs KKR - No Result (rain)
    ...
    # Match 20: RCB beat MI (at Wankhede)
    ...
    # Match 21: SRH beat RR
    {"date": "2026-04-13", "team1": "Sunrisers Hyderabad", "team2": "Rajasthan Royals", "winner": "Sunrisers Hyderabad", "city": "Hyderabad", "venue": "Rajiv Gandhi International Stadium", "toss_winner": "Sunrisers Hyderabad", "toss_decision": "bat", "result": "runs", "result_margin": 25},
    # Match 22: CSK beat KKR
    {"date": "2026-04-14", "team1": "Chennai Super Kings", "team2": "Kolkata Knight Riders", "winner": "Chennai Super Kings", "city": "Chennai", "venue": "MA Chidambaram Stadium", "toss_winner": "Chennai Super Kings", "toss_decision": "bat", "result": "runs", "result_margin": 32},
    # Match 23: RCB beat LSG
    {"date": "2026-04-15", "team1": "Royal Challengers Bangalore", "team2": "Lucknow Super Giants", "winner": "Royal Challengers Bangalore", "city": "Bangalore", "venue": "M Chinnaswamy Stadium", "toss_winner": "Royal Challengers Bangalore", "toss_decision": "field", "result": "wickets", "result_margin": 5},
    # Match 19b: CSK beat DC
...
venue_chase_bias = {
    ...
    "Wankhede Stadium": 0.55,  # Updated: 78% toss-win-bowl-first in 2026
...
# ============================================================================
# 5. PREDICT: MI vs PBKS
# ============================================================================
print("\n[5/7] Predicting MI vs PBKS...")
...
mi_matches_recent = all_matches[(all_matches["team1"] == MI) | (all_matches["team2"] == MI)].tail(5)
pbks_matches_recent = all_matches[(all_matches["team1"] == PBKS) | (all_matches["team2"] == PBKS)].tail(5)

mi_wins_last5 = sum(mi_matches_recent["winner"] == MI)
pbks_wins_last5 = sum(pbks_matches_recent["winner"] == PBKS)
mi_momentum = mi_wins_last5 / 5
pbks_momentum = pbks_wins_last5 / 5

mi_pbks = all_matches[
    ((all_matches["team1"] == MI) & (all_matches["team2"] == PBKS)) |
    ((all_matches["team1"] == PBKS) & (all_matches["team2"] == MI))
]
total_h2h = len(mi_pbks[mi_pbks["winner"].isin([MI, PBKS])])
mi_h2h_wins = sum(mi_pbks["winner"] == MI)
pbks_h2h_wins = total_h2h - mi_h2h_wins
mi_h2h_winrate = mi_h2h_wins / total_h2h if total_h2h > 0 else 0.5

# MI is team1 (HOME - Wankhede), PBKS is team2
match_features = {
    "elo_team1": mi_elo,
    "elo_team2": pbks_elo,
    "elo_diff": mi_elo - pbks_elo,
    "momentum_team1": mi_momentum,
    "momentum_team2": pbks_momentum,
    "momentum_diff": mi_momentum - pbks_momentum,
    "h2h_team1_winrate": mi_h2h_winrate,
    "h2h_matches": total_h2h,
    "home_team1": 1,   # MI home ground - Wankhede
    "home_team2": 0,
    "venue_chase_bias": 0.55,   # Wankhede - strong chase advantage, heavy dew in April
...
# 5 IPL titles, incredible home record. Short boundaries, flat track.
# BUT lost at home to RCB just 4 days ago (222/5 chasing 240)
# Reduced to +2% given recent home loss
adjustments["mi_wankhede_home"] = +0.02

# B. MI 2W-3L in 2026 - poor form (-3%)
# Beat KKR at home (6 wkts), Beat SRH away (4 wkts)
# Lost to DC away (6 wkts), Lost to RR away (27 runs), Lost to RCB at home (18 runs)
# 3 losses in last 4 matches - struggling badly
# Rohit Sharma has hamstring injury - major blow
adjustments["mi_poor_2026_form"] = -0.03

# C. Bumrah + Boult pace combo (+2%)
# Still world-class regardless of team form
# Bumrah is best T20 death bowler, Boult swings new ball
# Deepak Chahar adds depth, Shardul Thakur experience
adjustments["mi_bumrah_boult_pace"] = +0.02

# D. Rohit Sharma hamstring injury (-2%)
# Doubtful for this match per ESPN preview
# Massive blow - Wankhede is his fortress, key anchor
# If he plays, will be below 100% fitness
adjustments["rohit_injury"] = -0.02

# E. PBKS 3W-0L-1NR in 2026 - RED HOT form (-4%)
# Beat GT at home (20 runs), Beat CSK away in Chennai (5 wkts)
# Beat SRH at home (6 wkts), NR vs KKR (rain)
# 3rd in points table with +0.720 NRR
# Winning away in Chennai shows real quality
# Coming off 2025 where they topped league stage and reached final
adjustments["pbks_red_hot_form"] = -0.04

# F. Shreyas Iyer captaincy + form (-2%)
# Led PBKS to 2025 final, 604 runs that season
# Excellent tactical captain under Ponting's guidance
# Middle-order anchor, plays pace and spin equally well
adjustments["iyer_captaincy"] = -0.02

# G. PBKS bowling attack - Arshdeep, Jansen, Bartlett (-2%)
# Arshdeep Singh - India's T20I lead pacer, 21 wkts in 2025
# Marco Jansen - left-arm pace, bounce from height, bat at 7
# Xavier Bartlett - Australian quick, accurate death bowling
# Yuzvendra Chahal as impact sub adds mystery spin
# This attack can exploit Wankhede's early seam movement
adjustments["pbks_bowling_quality"] = -0.02

# H. PBKS beat MI at Wankhede in 2025 (-1%)
# Won by 4 wickets chasing, then beat MI in Qualifier 2
# PBKS have recent Wankhede success against MI
# Psychological edge in this specific matchup
adjustments["pbks_recent_h2h"] = -0.01

# I. MI H2H all-time: 17-17 even (+0%)
# Perfectly balanced rivalry - no advantage either way
adjustments["h2h_even"] = 0.0

# J. Marcus Stoinis X-factor (-1%)
# Power-hitting all-rounder at 5/6, medium pace option
# Can finish games or accelerate in middle overs
# Adds batting depth and bowling versatility
adjustments["stoinis_xfactor"] = -0.01

# K. MI batting depth at Wankhede (+1%)
# SKY (MVP 2025, 717 runs), Tilak Varma, Hardik Pandya
# Will Jacks explosive power, de Kock at top
# Wankhede flat track suits their big hitters
# Even without Rohit at 100%, significant depth
adjustments["mi_batting_depth"] = +0.01

total_adjustment = sum(adjustments.values())
adjusted_mi_prob = np.clip(base_mi_prob + total_adjustment, 0.05, 0.95)
adjusted_pbks_prob = 1 - adjusted_mi_prob
...
# ============================================================================
print("\n" + "=" * 70)
print("  PREDICTION REPORT: MI vs PBKS | IPL 2026 Match 24")
print("  Wankhede Stadium, Mumbai | April 16, 2026 | 7:30 PM IST")
print("=" * 70)

print("\n--- TEAM PROFILES ---")
print(f"  {'':30s} {'MI':>12s} {'PBKS':>12s}")
print(f"  {'Elo Rating':30s} {mi_elo:>12.1f} {pbks_elo:>12.1f}")
print(f"  {'Last 5 Matches (W/5)':30s} {mi_wins_last5:>12d} {pbks_wins_last5:>12d}")
print(f"  {'Momentum (last 5 win%)':30s} {mi_momentum:>12.1%} {pbks_momentum:>12.1%}")
print(f"  {'H2H Record (all-time)':30s} {mi_h2h_wins:>7d}W/{total_h2h:d} {pbks_h2h_wins:>7d}W/{total_h2h:d}")
print(f"  {'2025 Season':30s} {'9W-7L (4th)':>12s} {'10W-4L (1st)':>12s}")
print(f"  {'2026 Record':30s} {'2W-3L':>12s} {'3W-0L-1NR':>12s}")
print(f"  {'Home Advantage':30s} {'YES':>12s} {'NO':>12s}")
print(f"  {'Captain':30s} {'H Pandya':>12s} {'S Iyer':>12s}")

print("\n--- KEY PLAYERS ---")
print(f"  MI:  Rohit Sharma (DOUBTFUL - hamstring injury)")
print(f"       Quinton de Kock (wk, opener), Suryakumar Yadav (MVP 2025)")
print(f"       Tilak Varma (emerging star), Hardik Pandya (c, finisher)")
print(f"       Will Jacks (power hitter), Naman Dhir (AR)")
print(f"       Jasprit Bumrah (best T20 bowler), Trent Boult (swing)")
print(f"       Mitchell Santner (spin), Deepak Chahar, Shardul Thakur")
print(f"  PBKS: Priyansh Arya (explosive opener), Prabhsimran Singh (wk)")
print(f"       Cooper Connolly (left-hand bat), Shreyas Iyer (c, anchor)")
print(f"       Nehal Wadhera (power), Marcus Stoinis (finisher/pace)")
print(f"       Shashank Singh (finisher), Marco Jansen (pace AR)")
print(f"       Xavier Bartlett (Aus quick), Vijaykumar Vyshak (pace)")
print(f"       Arshdeep Singh (India T20I lead pacer)")
print(f"       Impact: Yuzvendra Chahal (leg spin)")
...
print("\n" + "=" * 70)
winner = "MI" if adjusted_mi_prob > 0.5 else "PBKS"
winner_full = MI if winner == "MI" else PBKS
loser = "PBKS" if winner == "MI" else "MI"
win_prob = max(adjusted_mi_prob, adjusted_pbks_prob)
...
elif winner == "PBKS" and pbks_margins:
    avg_margin = int(np.mean(pbks_margins))
    print(f"  PREDICTED MARGIN: {avg_margin} runs")

print("\n--- NARRATIVE ---")
if winner == "PBKS":
    print(f"  Punjab Kings continue their stunning 2026 campaign with a clinical")
    print(f"  win at the Wankhede. Arshdeep Singh's pace rattles MI's top order,")
    print(f"  while Shreyas Iyer anchors the chase with composure. MI, struggling")
    print(f"  with Rohit's fitness and 3 losses in 4 matches, cannot contain PBKS's")
    print(f"  balanced attack. Marco Jansen's left-arm pace and Stoinis's finishing")
    print(f"  prove too much. The 2025 finalists show they mean business again.")
else:
    print(f"  Mumbai Indians finally find their groove at the Wankhede. Bumrah and")
    print(f"  Boult deliver a devastating new-ball spell, and SKY's brilliance on")
    print(f"  a flat batting track anchors a competitive total. Despite PBKS's hot")
    print(f"  streak, MI's home comfort and big-match experience at the Wankhede")
    print(f"  prove decisive. Hardik Pandya leads from the front to halt the slide.")
